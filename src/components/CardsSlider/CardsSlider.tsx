...
function CardsSlider({Cards}) {
  ...
  return (
      ...
      <button onClick={prevCard}> <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20">
            <path d="M400 976 0 576l400-400 56 57-343 343 343 343-56 57Z" />
          </svg></button>
      <button onClick={nextCard}><svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20">
